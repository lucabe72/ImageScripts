...
/*CHANGE - D*/ External_in1 :: FromDevice(eth0, PROMISC true);
/*CHANGE - D*/ Internal_out :: ToDevice(eth1);
...
/*CHANGE - D */ Internal_in :: FromDevice(eth1, PROMISC true);
/*CHANGE - D */ External_out :: ToDevice(eth0);
...
/*CHANGE*/	12/0800 30/C0A8????,			//1 packets whith private (192.168.x.x) Ip dest
