...
/*CHANGE*/ Internal_out :: ToDevice(eth9);
...
/*CHANGE*/ macMaster :: StoreData(0,\<000c29aaf650>);  //mac of the router 
/*CHANGE*/ mac1 :: StoreData(0,\<000c29aaf650>);   //mac of the router
/*CHANGE*/ mac2 :: StoreData(0,\<000c29aaf651>);   //mac of the router
/*CHANGE*/ mac3 :: StoreData(0,\<000c29aaf652>);   //mac of the router
/*CHANGE*/ mac4 :: StoreData(0,\<000c29aaf653>);   //mac of the router
...
balancer[1] -> mac2 -> ToInQueue;
balancer[2] -> mac3 -> ToInQueue;
balancer[3] -> mac4 -> ToInQueue;
...
/*CHANGE*/ Internal_in :: FromDevice(eth9, PROMISC true);
...
//Private IP address Packets: 10.10.x.x
//ARP Request, ARP reply
classifierInExt :: Classifier(
		12/0800 30/E00001BA 36/1152, 		//0 pacchetti DIST
/*CHANGE*/	12/0800 30/0A0A0????,			//1 packets whith private (192.168.x.x) Ip dest
...
Dropper :: Discard();
/*CHANGE*/ macSource :: StoreData(6,\<000c295c8870>);    //mac of the LB, external link
/*CHANGE*/ ARPSource :: StoreData(6,\<000c295c8870>);    //mac of the LB, external link
/*CHANGE*/ ARPSender :: StoreData(22,\<000c295c8870>);   //mac of the LB, external link
queue2 :: Queue(1000);
